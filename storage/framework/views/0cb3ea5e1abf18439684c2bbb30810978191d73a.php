...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Password_repeat')); ?></label>
                        ...
                        <div class="row mb-3">
                            <label for="flexSwitchCheckDefault" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Rules')); ?></label>

                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" required role="switch" id="flexSwitchCheckDefault">
                                    <label class="form-check-label" for="flexSwitchCheckDefault">согласие с правилами регистрации</label>
                                  </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/users/vpfkmmdh/gfpykxy-m1/resources/views/auth/register.blade.php ENDPATH**/ ?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/admin')); ?>">Админ панель</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php else: ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<?php echo e(url('/cart')); ?>">Корзина</a>
...
<?php /**PATH /srv/users/vpfkmmdh/gfpykxy-m1/resources/views/layouts/app.blade.php ENDPATH**/ ?>